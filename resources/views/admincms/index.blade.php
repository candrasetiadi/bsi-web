                      ...
                      <tbody>
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img class="img-avatar" src="{{ asset('assets/image/avatars/1.jpg') }}" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img class="img-avatar" src="{{ asset('assets/image/avatars/2.jpg') }}" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img class="img-avatar" src="{{ asset('assets/image/avatars/3.jpg') }}" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img class="img-avatar" src="{{ asset('assets/image/avatars/4.jpg') }}" alt="admin@bootstrapmaster.com">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img class="img-avatar" src="{{ asset('assets/image/avatars/5.jpg') }}" alt="admin@bootstrapmaster.com">
                              <span class="avatar-status badge-success"></span>
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img class="img-avatar" src="{{ asset('assets/image/avatars/6.jpg') }}" alt="admin@bootstrapmaster.com">
                              <span class="avatar-status badge-danger"></span>
                            </div>
                          </td>
                          <td>
            ...
            <div class="list-group list-group-accent">
              ...
              <div class="list-group-item list-group-item-accent-warning list-group-item-divider">
                <div class="avatar float-right">
                  <img class="img-avatar" src="{{ asset('assets/image/avatars/7.jpg') }}" alt="admin@bootstrapmaster.com">
                </div>
                <div>Meeting with
                  <strong>Lucas</strong>
                </div>
              ...
              <div class="list-group-item list-group-item-accent-primary list-group-item-divider">
                ...
                <div class="avatars-stack mt-2">
                  ...
                  <div class="avatar avatar-xs">
                    <img class="img-avatar" src="{{ asset('assets/image/avatars/8.jpg') }}" alt="admin@bootstrapmaster.com">
                  </div>
                </div>
              </div>
            </div>
